...
def calculate_demographic_data(print_data=True):
    ...
    rich_per_country_percentage = ((rich_per_country / total_per_country) * 100).sort_values(ascending=False)

    highest_earning_country = rich_per_country_percentage.index[0]
    highest_earning_country_percentage = round(rich_per_country_percentage[0], 1)
